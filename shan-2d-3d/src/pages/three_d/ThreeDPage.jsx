...
const ThreeDPage = () => {
  ...
  const chooseNumber = () => {
    if (!digitInput.trim()) {
      toast.error(t('enter_three_digit'));
      return;
    }
    ...
    if (selectedDigits.includes(digit)) {
      toast.error(t('number_already_selected'));
      return;
    }
    ...
    <div className="min-h-screen bg-[#101223] text-white p-4">
      ...
      <div className="max-w-md mx-auto mb-6">
        <div className="flex justify-between items-center">
          ...
          <h1 className="text-xl font-bold text-yellow-400">{t('three_d_betting')}</h1>
          <LanguageSwitcher />
        </div>
      </div>
      ...
      <div className="max-w-md mx-auto mb-6">
        <div className="flex justify-around items-center bg-[#12486b] border-2 border-[#576265] rounded-3xl p-3">
          ...
          <span className="text-base font-medium">{t('wallet')}</span>
      ...
      <div className="max-w-md mx-auto">
        <p className="text-center text-gray-300 mb-4 text-sm">{t('select_numbers')}</p>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <input
            ...
            placeholder={t('three_digit_number')}
        ...
        <div className="flex justify-end mb-6">
          ...
          <div className="mb-10">
            <p className="text-gray-300 text-sm mb-3">{t('selected_numbers')}</p>
            <div className="min-h-[150px] border border-gray-500 rounded-lg p-4 bg-white bg-opacity-5">
              {selectedDigits.length === 0 ? (
                <p className="text-gray-400 text-center py-8">{t('selected_numbers')}</p>
              ) : (
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                {t('place_bet')}
                           ...
                           {/* Fixed Bottom Footer */}
        {/* <div className="fixed bottom-20 left-0 right-0 p-4 border-t border-gray-200 rounded-lg mx-4 shadow-lg z-40">
          <div className="max-w-md mx-auto">
            <div className="grid grid-cols-2 gap-4">
              <button
                onClick={removeNumber}
