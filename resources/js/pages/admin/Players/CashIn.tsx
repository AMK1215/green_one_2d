...
export default function PlayerCashIn({ player, agentBalance }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(`/admin/players/${player.id}/cash-in`);
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Deposit to ${player.name}`} />
            ...
            <div className="max-w-2xl mx-auto space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-gray-600 dark:text-gray-400">
                            Transfer money from your account to {player.name}
                        </p>
                    </div>
                </div>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-blue-600">
                                {formatCurrency(player.balanceFloat)}
                            </div>
                        </CardContent>
                    </Card>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Transfer money to {player.name} ({player.user_name})
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
