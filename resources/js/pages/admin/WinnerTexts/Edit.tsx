...
export default function WinnerTextEdit({ winnerText }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(`/admin/winner-texts/${winnerText.id}`, {
            method: 'put',
        });
    };
            ...
            <div className="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Update the details for your winner text entry
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex gap-4">
                                <Button type="submit" disabled={processing}>
                                    {processing ? 'Updating...' : 'Update Winner Text'}
                                </Button>
                                <Link href="/admin/winner-texts">
