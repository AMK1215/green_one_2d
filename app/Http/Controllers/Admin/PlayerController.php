...
class PlayerController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('admin/Players/Index', [
            'users' => $users,
            'canCreate' => $authUser->hasRole('Agent'), // Only Agents can create players
        ]);
    }
    ...
    public function getCashIn(User $player): Response
    {
        // abort_if(
        ...
        return Inertia::render('admin/Players/CashIn', [
            'player' => $player,
    ...
    public function makeCashIn(TransferLogRequest $request, User $player)
    {
        ...
        try {
            ...
            return redirect()->route('admin.players.index')
                ->with('success', 'Money deposited to player successfully!');
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function getCashOut(User $player): Response
    {
        // abort_if(
        //     Gate::denies('make_transfer'),
        //     Response::HTTP_FORBIDDEN,
        ...
        return Inertia::render('admin/Players/CashOut', [
            'player' => $player,
            'playerBalance' => $player->balanceFloat,
        ]);
    }
    ...
    public function makeCashOut(TransferLogRequest $request, User $player)
    {
        ...
        try {
            ...
            return redirect()->route('admin.players.index')
                ->with('success', 'Money withdrawn from player successfully!');
        } catch (Exception $e) {
            DB::rollBack();
    ...
    private function getAgent()
    {
        ...
        // If current user is an agent, return the user
        if ($user->hasRole(self::AGENT_ROLE)) {
            return $user;
        }
        
        // If current user is owner, return the user (owner can create players too)
    ...
    public function getTransferLogs(User $player): Response
    {
        ...
        return Inertia::render('admin/Players/TransferLogs', [
            'player' => $player,
